...
export default function StaffLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden" data-testid="staff-layout">
      <aside className="flex flex-col w-56 h-screen bg-secondary sticky top-0 border-r border-white/5">
        <div className="flex items-center gap-3 px-4 py-5 border-b border-white/10">
          ...
          <div>
            ...
            <p className="text-white/40 text-xs">Field Portal</p>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 p-3">
          {user && <div className="px-2 py-1 mb-2">
