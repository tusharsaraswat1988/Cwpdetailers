...
import { LayoutDashboard, Package, CreditCard, ClipboardList, Sparkles, Droplets, Users } from "lucide-react";
...
const tabs = [
  ...
  { href: "/admin/services?tab=daily-cleaning", label: "Plans", icon: Package, exact: false as const },
  { href: "/admin/daily-cleaning/subscriptions", label: "Subscriptions", icon: CreditCard, exact: false as const },
  { href: "/admin/daily-cleaning/visits", label: "Visits", icon: ClipboardList, exact: false as const },
  { href: "/admin/daily-cleaning/washes", label: "Wash History", icon: Droplets, exact: false as const },
  { href: "/admin/assign-services", label: "Assign Staff", icon: Users, exact: false as const },
